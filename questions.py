...
demonstrate the Candidate-Elimination algorithm in python to output a
...
6. Write a program to implement Naïve Bayes algorithm in python and to display the
results  using confusion matrix and
accuracy.
